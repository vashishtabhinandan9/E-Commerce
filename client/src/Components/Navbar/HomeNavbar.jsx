  ...
  return (
    <>
      <div className="lg:hidden w-full h-16 flex items-center  border-b-4 border-gray-200">
        <div id="NavSearch_Icon" className=" w-20 h-full mt-2 py-2">
          <Left_Slide_Menu
            Component={<SeachPanelMobile />}
            Icon={<IoIosSearch className="w-full h-8" />}
            Heading="SEARCH OUR SITE"
          />
        </div>
  ...
  return (
    <>
      <div className="hidden lg:flex h-16 border-b-4 border-gray-200">
        <div
          id="SVGLogo"
          className="w-40 h-full flex items-center mx-auto   border-2 border-green-400"
        >
          <img
            src={BlackLogo}
            alt="SamneWali"
        ...
        <div
          id="CenterNavElements"
          className=" w-7/12 h-12 m-auto bg-gray-100 shadow-md  flex items-center gap-3  border border-gray-200 rounded"
        >
          <div
            id="NavDropDown"
            className="h-5/6 flex items-center gap-2 bg-gray-100  border-gray-300 pr-2"
