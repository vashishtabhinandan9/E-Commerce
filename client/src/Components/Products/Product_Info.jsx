      ...
      <div className=" flex flex-wrap gap-2 mt-2 ">
        ...
        >
          <div className="w-full h-full">
            <Slider {...settings} className=" h-max border-2 border-red-300 mx-4">
              {Categories.map((item, index) => {
                return (
                  <div key={index} id="contain" className=" h-96 border-2 border-blue-300 ">
        ...
        <div id="ProductInfo" className="w-full  md:w-7/12 border-2 border-green-400 mx-2 my-2 p-4">
                  ...
                  {Sizes.map((item) => {
                    return (
                      <>
                          ...
                          ></input>
                          <label for={item.name}  className={`peer-checked/${item.name}:bg-red-500 `}> {item.name}</label>
                      </>
                    );
                  })}
                </fieldset>
